...
void LIA::AppWindow::loadSettings() {
    ...
    XmlLoader xmlLoader;
    XmlLoader::XmlData xmlData = xmlLoader.load("./data/xml/settings/appWindow.xml");
    ...
    XmlLoader::XmlData xmlCamera = xmlLoader.load("./data/xml/settings/controls/camera.xml");
